...
cargar_datos_auxiliares <- function() {
  ...
  # Cargar credenciales BD (solo si existe .Renviron localmente)
  ...
  # Obtener credenciales (desde .Renviron local o variables de entorno GitHub Actions)
  ...
  log_info("🔌 Conectando a BD: {db_user}@{db_host}:{db_port}/{db_name}")
