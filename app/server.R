...
server <- function(input, output, session) {
  ...
  output$resumen_sistema <- renderText({
    ...
    resumen <- paste(
      ...
      "",
      "MODEL INFORMATION:",
      "- Algorithm: XGBoost Native API with GPU acceleration",
      "- Training data: 10 years historical (2015-2025)",
      "- GPU: RTX 4070 Ti (12GB VRAM)",
      "- Variables: Temporal, meteorological, and seasonal predictors",
      "",
